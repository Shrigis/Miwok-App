...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create array list for Word values
        ...
        // Create a WordAdapter object named "adapter" and pass it the ArrayList named "words"
        WordAdapter adapter =
        ...
        listView.setBackgroundColor(ContextCompat.getColor(this, R.color.category_phrases));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mMediaPlayer.start();
                Toast.makeText(PhrasesActivity.this, word.getMiwokTranslation(), Toast.LENGTH_SHORT).show();

                mMediaPlayer.setOnCompletionListener(mCompletionListener);

                Toast.makeText(PhrasesActivity.this, "MediaPlayer Released", Toast.LENGTH_SHORT).show();
            }
        });
    }
    /**
